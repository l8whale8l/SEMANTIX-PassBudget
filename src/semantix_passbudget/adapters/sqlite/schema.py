...
Recovering an older local file means restoring
...
SCHEMA_VERSION = 2
#: Bundled migration scripts, applied in ascending version order. v2 adds the catalog tables so
#: scenarios/revisions/snapshots survive a restart; see db/sqlite/schema_v2.sql.
_SCRIPTS: tuple[tuple[int, str], ...] = ((1, "schema_v1.sql"), (2, "schema_v2.sql"))
